  ...
  return (
    ...
    <tr className="block md:table-row border-b md:border-b-0 border-lightGray dark:border-gray-700 mb-4 md:mb-0 rounded-lg md:rounded-none bg-white dark:bg-gray-800 md:bg-transparent shadow-md md:shadow-none md:hover:bg-lightGray/50 dark:md:hover:bg-gray-700/50 transition-colors duration-150">
      ...
      <td data-label="Amount" className="p-3 md:p-4 flex justify-between items-center md:table-cell text-left md:text-right text-mediumGray dark:text-gray-300 whitespace-nowrap border-b md:border-b-0 border-lightGray dark:border-gray-700/50">
        <span className="font-bold md:hidden">Amount:</span> ${project.agreementAmount.toLocaleString()}
      </td>
      <td data-label="Paid" className="p-3 md:p-4 flex justify-between items-center md:table-cell text-left md:text-right text-secondary dark:text-green-400 whitespace-nowrap border-b md:border-b-0 border-lightGray dark:border-gray-700/50">
        <span className="font-bold md:hidden">Paid:</span> ${project.advancePaid.toLocaleString()}
      </td>
      <td data-label="Remaining" className="p-3 md:p-4 flex justify-between items-center md:table-cell text-left md:text-right font-semibold text-redError dark:text-red-400 whitespace-nowrap border-b md:border-b-0 border-lightGray dark:border-gray-700/50">
        <span className="font-bold md:hidden">Remaining:</span> ${project.remainingAmount.toLocaleString()}
      </td>
        ...
        <div className={`bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg mb-4 border-l-4 ${borderColor} transform hover:scale-[1.02] hover:shadow-xl transition-all duration-300 flex flex-col justify-between`}>
          <div>
            ...
            <div className="space-y-2 text-sm text-mediumGray dark:text-gray-400">
               ...
               <div className="flex items-center gap-2">
                 ...
                 <span>Amount: <span className="font-medium text-darkGray dark:text-gray-200">${project.agreementAmount.toLocaleString()}</span></span>
               </div>
               <div className="flex items-center gap-2">
          ...
          <div className="mt-4">
              <div className="flex justify-between items-center mb-1">
                 <span className="text-xs font-semibold text-redError">Remaining: ${project.remainingAmount.toLocaleString()}</span>
    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8 animate-fade-in-up">
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 w-full text-center">
          ...
          <p className="text-4xl font-extrabold text-secondary">${totalAdvance.toLocaleString()}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 w-full text-center">
          <h4 className="text-lg font-semibold text-mediumGray dark:text-gray-400">Total Remaining</h4>
          <p className="text-4xl font-extrabold text-redError">${totalRemaining.toLocaleString()}</p>
        </div>
      </div>
