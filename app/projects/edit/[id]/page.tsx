                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className={inputContainerStyle}>
                                    ...
                                    <input type="text" name="name" value={form.name || ''} onChange={handleChange} className={`${inputBaseStyle} ${errors.name ? inputErrorStyle : 'focus:ring-primary'}`} />
                                </div>
                            ...
                            <div>
                                ...
                                <div className={inputContainerStyle}>
                                    ...
                                    <select name="customerId" value={form.customerId || ''} onChange={handleChange} className={`${inputBaseStyle} ${errors.customerId ? inputErrorStyle : 'focus:ring-primary'}`} >
                            ...
                            <div>
                                ...
                                <div className={inputContainerStyle}>
                                    ...
                                    <input type="text" name="projectType" value={form.projectType || ''} onChange={handleChange} className={`${inputBaseStyle} ${errors.projectType ? inputErrorStyle : 'focus:ring-primary'}`} />
                                </div>
                            ...
                            {/* Expected Completion Date */}
                             <div>
                                ...
                                <div className={inputContainerStyle}>
                                    ...
                                    <input type="date" name="expectedCompletionDate" value={form.expectedCompletionDate || ''} onChange={handleChange} className={`${inputBaseStyle} ${errors.expectedCompletionDate ? inputErrorStyle : 'focus:ring-primary'}`} />
                                </div>
                            ...
                            <div>
                                ...
                                <div className={inputContainerStyle}>
                                    ...
                                    <select name="status" value={form.status || 'Active'} onChange={handleChange} className={`${inputBaseStyle} focus:ring-primary`}>
