              ...
              {advancePayments.map((row, idx) => (
                <div key={idx} className="flex gap-2 mb-2">
                  ...
                  {advancePayments.length > 1 && (
                    <button type="button" onClick={() => removeAdvancePaymentRow(idx)} className="text-red-500">X</button>
                  )}
                </div>
              ))}
              <div className="flex gap-2">
                <button type="button" onClick={addAdvancePaymentRow} className="text-primary underline">Add Another Account</button>
                <button type="button" onClick={() => setShowAddAccountModal(true)} className="text-primary underline">Add Account</button>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setShowAddAccountModal(false)}><X /></button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setShowAddCustomerModal(false)}><X /></button>
            </div>
