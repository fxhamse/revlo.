  ...
  const handleSave = async () => {
    ...
    try {
      const updatedSettings = {
        ...
        customFont: editCustomFont, // New
        notificationSound: editNotificationSound, // New
        profilePicture: editProfilePicture || '', // Ensure string type
        highContrast: editHighContrast, // New
        textSize: editTextSize, // New
        defaultExportFormat: editDefaultExportFormat, // New
      };
      console.log("Saving Personalization Settings:", updatedSettings);
