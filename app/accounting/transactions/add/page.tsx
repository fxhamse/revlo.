...
export default function AddTransactionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSelectedAccount(''); setFromAccount(''); setToAccount('');
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="TRANSFER_OUT">Wareejin (Laga Wareejiyay)</option>
                <option value="TRANSFER_IN">Wareejin (Loo Wareejiyay)</option>
